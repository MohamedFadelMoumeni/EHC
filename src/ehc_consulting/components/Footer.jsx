  ...
  const sections = [
    {
      title: "Liens rapides",
      links: [
        { text: "À propos", href: "#apropos_consulting" },
        { text: "Services", href: "#solutions_consulting" },
        { text: "Contact", href: "#contact_consulting" }
      ]
    },
    {
      title: "Nos services",
      links: [
        { text: "Management des organisations", href: "#solutions_consulting" },
        { text: "Gestion du changement", href: "#solutions_consulting" },
        { text: "Stratégie & Innovation", href: "#solutions_consulting" }
      ]
    }
  ];
