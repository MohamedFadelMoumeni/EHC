    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-2 gap-6">
        ...
        >
          ...
          <option value="Management des organisations">Conception et ingénierie de formation</option>
          <option value="Digitalisation Performance">Formations standard et sur-mesure</option>
          <option value="Performance globale">Déploiement et accompagnement</option>
          <option value="Performance globale">Éligibilité CSF</option>
