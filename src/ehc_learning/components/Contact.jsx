...
export default function LrContact() {
  ...
  return (
    <section id="contact_learning" className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-8 text-primary">Contactez-nous</h2>
        <p className="text-lg text-gray-700 mb-12 text-center max-w-3xl mx-auto">
          Rejoignez-nous pour transformer vos talents en atouts stratégiques. 
          Découvrez comment nous pouvons vous accompagner dans la réussite de 
