    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-2 gap-6">
        ...
        >
          ...
          <option value="Management des organisations">Organisation d'Événements sur Mesure</option>
          <option value="Digitalisation Performance">Gestion de Projets Clés en Main</option>
          <option value="Performance globale">Services d'Accompagnement</option>
          <option value="Performance globale">Solutions Innovantes et Digitales</option>
          <option value="Performance globale">Services aux Entreprises</option>
          <option value="Performance globale">Autres</option>
        </select>
        <select
