    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-2 gap-6">
        ...
        >
          ...
          <option value="Management des organisations">Recrutement pour le secteur public</option>
          <option value="Digitalisation Performance">Accompagnement intégral</option>
          <option value="Performance globale">Plateforme digitale innovante</option>
          <option value="Performance globale">Chasse de tête</option>
          <option value="Performance globale">Recrutement sur mesure</option>
