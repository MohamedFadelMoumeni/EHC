...
import { UserPlus, Upload, X, ChevronLeft, MessageSquare } from 'lucide-react';
...
const TestimonialAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8081/api/testimonials', formDataToSend, {
        headers: {
  ...
  // Add the SectionHeader component definition here
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 p-8">
            ...
            {/* Author Information */}
            <div>
              <SectionHeader icon={UserPlus} title="Author Information" />
