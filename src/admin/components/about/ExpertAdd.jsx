...
import { UserPlus, Upload, X, ChevronLeft, Award, Book, Globe, Clock, Briefcase } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const expertData = {
        ...
        expertCategory: formData.expertCategory, // Added to the payload
      };
      formDataToSend.append('expert', new Blob([JSON.stringify(expertData)], { type: 'application/json' }));
      if (imageFile) {
        formDataToSend.append('imageFile', imageFile);
      }
      await axios.post('http://localhost:8081/api/experts', formDataToSend, {
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 p-8">
            ...
            <div>
              <SectionHeader icon={UserPlus} title="Personal Information" />
