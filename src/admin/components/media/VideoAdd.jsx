...
const VideoAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('http://localhost:8081/api/videos', submitData, {
        headers: {
    ...
    <div className="min-h-screen bg-slate-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#168187] rounded-t-lg p-6 shadow-lg">
          ...
          <p className="text-slate-100 mt-2">Create a new video entry</p>
        </div>
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 flex items-center gap-2 mb-2">
                  ...
                  Video File (optional if URL provided)
                </label>
                <input
                  type="file"
